...
namespace Mohammad.Logging
{
        ...
        where TWriter : class, IWriter<TLogEntity> where TLogEntity : LogEntity, new()
    {
        ...
        public bool ShowInDebuggerTracer { get { return this.Writer.ShowInDebuggerTracer; } set { this.Writer.ShowInDebuggerTracer = value; } }
        ...
        public void Info(object text, object moreInfo = null, bool? raiseEventOnly = null)
        {
            ...
            var logEntity = entity ?? new TLogEntity {Text = text, MoreInfo = moreInfo};
        ...
        {
            this.Log(new TLogEntity {Exception = ex, Level = LogLevel.Error, Text = text, MoreInfo = moreInfo}, raiseEventOnly ?? this.RaiseEventOnly);
        }

        public void Fatal(object text, object moreInfo = null, Exception ex = null, bool? raiseEventOnly = null)
        {
            var entity = text as TLogEntity;
            var logEntity = entity ?? new TLogEntity {Exception = ex, Text = text, MoreInfo = moreInfo};
        ...
        {
            this.Config = CodeHelper.Catch(() => (LoggingConfigurationHandler) ConfigurationManager.GetSection("library.LogSystem/loggingConfigurationHandler")) ??
