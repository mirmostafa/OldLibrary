...
namespace Mohammad.Wpf.Windows.Dialogs
{
    public static class LibraryDialog
    {
        ...
        public static bool? ShowDialog<TLibraryCommonPage>([NotNull] Func<TLibraryCommonPage> creator, out TLibraryCommonPage page, Window owner = null,
        ...
        public static bool? ShowDialog<TLibraryCommonPage>([NotNull] Func<TLibraryCommonPage> creator, Window owner = null, bool? addEffetcts = null)
        ...
        public static bool? ShowDialog([NotNull] LibraryCommonPage page, Window owner = null, bool? addEffetcts = null)
        {
            if (page == null)
