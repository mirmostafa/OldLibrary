...
namespace Mohammad.Wpf.Windows.Controls
{
    public class PageBase : Page, INotifyPropertyChanged, IWindowHosted
    {
        ...
        protected virtual void OnBindingData(BindingDataEventArgs e) { this.BindingData.Raise(this, e); }
        ...
        protected virtual void OnTitleChanged() { this.TitleChanged.Raise(this); }
