...
namespace Mohammad.Wpf.Windows.Controls
{
    ...
    public partial class LabeledTextBox : IFlickable, IBindable
    {
        ...
        public static readonly DependencyProperty HeaderWidthProperty = DependencyProperty.Register("HeaderWidth",
            typeof(double),
            typeof(LabeledTextBox),
        ...
        {
            get { return ((double) this.GetValue(HeaderWidthProperty)).NotNull((DefaultHeaderWidth ?? 80L).ToLong()); }
            set
            {
        ...
        {
            get { return this.TextBlock.TextBlockStyle; }
            set
            {
