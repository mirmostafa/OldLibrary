...
namespace Mohammad.Helpers
{
    ...
    {
        public static void Initialize([NotNull] this HttpConfiguration config, Action<HttpActionContext> onApiExecuting = null,
            Action<HttpActionExecutedContext> onApiExecuted = null, Action<HttpActionExecutedContext> onHandlingException = null,
