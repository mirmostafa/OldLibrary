...
namespace Mohammad.Threading
{
    ...
    public class AsyncPool
    {
        ...
        public IEnumerable<Async> Asyncs { get { return this.AsyncsQ.AsEnumerable(); } }
        protected virtual Queue<Async> AsyncsQ { get; }
        public string Name { get; }
        public uint MaximumCount { get; set; }
        protected Collection<Async> Stocks { get; }
        public IEnumerable<Async> Jobs { get { return this.Stocks.AsEnumerable(); } }
        ...
        public override string ToString() { return string.Format("{0} Asyncs: {1}, Jobs: {2}", this.Name, this.AsyncsQ.Count, this.Stocks.Count); }
