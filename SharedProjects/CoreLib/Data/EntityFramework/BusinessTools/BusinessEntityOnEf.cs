...
{
    public abstract class BusinessEntityOnEf<TEntity, TDateContext, TBusinessEntity> : BusinessEntity<TEntity, TBusinessEntity>, IDisposable
        where TEntity : EntityObject, new() where TDateContext : ObjectContext where TBusinessEntity : BusinessEntity<TEntity, TBusinessEntity>, new()
    {
        ...
        ~BusinessEntityOnEf() { this.Dispose(false); }
