...
namespace Mohammad.Helpers.Console.Menu
{
    ...
    public class ConsoleMenuItem : IEquatable<ConsoleMenuItem>
    {
        ...
        public ConsoleMenuItem(char hotKey, string text, IEnumerable<ConsoleMenuItem> children, EventHandler<ConsoleMenuItemHotKeyPressedEventArgs> hotKeyPressed,
            object extraArgs)
        {
        ...
        public override int GetHashCode() { return this.HotKey; }

        public static bool operator ==(ConsoleMenuItem menu1, ConsoleMenuItem menu2)
        {
            // ReSharper disable PossibleNullReferenceException
            var key1 = CodeHelper.Catch(() => menu1.HotKey, ' ');
            var key2 = CodeHelper.Catch(() => menu2.HotKey, ' ');
        ...
        public static ConsoleMenuItem Show(IEnumerable<ConsoleMenuItem> menuItems, string menuTitle, string choisePrompt = null, bool? showSelectedKey = null,
        ...
        public static ConsoleKeyInfo ShowSimpleMenu(IDictionary<char, string> items, string caption = null, string prompt = null, bool? showSelectedKey = null)
        {
    ...
    public class ConsoleMenuItemList : List<ConsoleMenuItem>
    {
        ...
        public ConsoleMenuItem Add(char hotKey, string text, IEnumerable<ConsoleMenuItem> children, EventHandler<ConsoleMenuItemHotKeyPressedEventArgs> hotKeyPressed,
            object extraArgs)
        {
