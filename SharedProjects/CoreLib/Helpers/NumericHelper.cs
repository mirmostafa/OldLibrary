...
namespace Mohammad.Helpers
{
    ...
    public static class NumericHelper
    {
        ...
        public static string ConvertBase(string num, int sourceBase, int desctinationBase) => Convert.ToString(Convert.ToInt32(num, sourceBase), desctinationBase);
        ...
        public static IEnumerable<int> GetPrimes(int min, int max) => Enumerable.Range(min, max - min)
        ...
        public static string ToCommaSeparate(this double num) => double.Parse(num.ToString(CultureInfo.InvariantCulture))
            .ToString("N", new NumberFormatInfo {NumberDecimalDigits = 0});
        ...
        public static bool HaveAllValue(params int?[] numbers) { return numbers.All(n => n.HasValue); }
    }
}