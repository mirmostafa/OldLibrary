...
namespace TestWpfApp45
{
    public partial class MainWindow
    {
        ...
        protected override WindowSettings OnWindowSettingsRequired() { return App.Injector.Settings.MainWindow; }
        ...
        private void LibCommand_OnIsCheckedChanged(object sender, ItemActedEventArgs<bool?> e)
        {
            if (e.Item ?? false)
                ...
                this._Watchers.ForEach(w => Catch(w.Stop));
        }
    }
}