...
namespace TestConsole45.Annotations
{
    /// <summary>
    ...
    public sealed class BaseTypeRequiredAttribute : Attribute
    {
        ...
        public BaseTypeRequiredAttribute(Type baseType) { this.BaseType = baseType; }
    }
    ...
    ///   return RedirectToAction("Bar"); // Exception: Cannot resolve action
    /// }
    /// </code>
    /// </example>
    ...
    public sealed class HtmlElementAttributesAttribute : Attribute
    {
        ...
        public HtmlElementAttributesAttribute(string name) { this.Name = name; }
    }
    ...
    public sealed class HtmlAttributeValueAttribute : Attribute
    {
        ...
        public HtmlAttributeValueAttribute(string name) { this.Name = name; }
    }
